...
public class FileIO {
	static final public String FULL_EMOTE_PATH = Environment
			.getExternalStorageDirectory().toString() + "/RedditEmotes/";
	...
	public ArrayList<File> getListOfFiles(String folder) {
		...
		try {
			if (isExternalStorageReadable()) {
				...
				folderListing = new ArrayList<File>(
	...
	public static String copyTempEmote(String emoteName) {
		...
		try {
			...
			InputStream in = new FileInputStream(FULL_EMOTE_PATH + emoteName
					+ ".png");
