...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_CREATE = "create table "
			+ TABLE_EMOTES + "(" + COLUMN_EMOTE_NAME
			+ " text primary key not null," + COLUMN_TAGS + " text not null,"
			+ COLUMN_NSFW + " integer not null," + COLUMN_DATE_MODIFIED
			+ " integer not null," + COLUMN_SOURCE + " text not null" + ");";

	private static final String INDEX_EMOTE = "CREATE INDEX " + EMOTE_INDEX
			+ " ON " + TABLE_EMOTES + " (" + COLUMN_EMOTE_NAME + ");";

	private static final String INDEX_TAGS = "CREATE INDEX " + TAGS_INDEX
			+ " ON " + TABLE_EMOTES + " (" + COLUMN_TAGS + ","
			+ COLUMN_EMOTE_NAME + ");";

	private static final String INDEX_SOURCE = "CREATE INDEX " + SOURCE_INDEX
			+ " ON " + TABLE_EMOTES + " (" + COLUMN_SOURCE + ","
			+ COLUMN_EMOTE_NAME + ");";
