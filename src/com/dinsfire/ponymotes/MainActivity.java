...
public class MainActivity extends ActionBarActivity {
	...
	if (itemId == R.id.action_updateDatabase) {
	    updateDatabase();
	    return true;
	...
	protected ArrayList<String> doInBackground(Object... params) {
	    ...
	    if (!Download.from(EmoteDownloadService.SERVER_DB_URL, context.getCacheDir().toString() + "/"
		    + DatabaseOpenHelper.SERVER_DATABASE_NAME)) {

		serverDBController = new DatabaseController(context, context.getCacheDir().toString() + "/"
			+ DatabaseOpenHelper.SERVER_DATABASE_NAME);
