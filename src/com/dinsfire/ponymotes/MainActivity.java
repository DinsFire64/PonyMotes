...
public class MainActivity extends ActionBarActivity {
	...
	public void openHelp() {
		...
		intent.putExtra("url",
				"http://dinsfire.com/projects/reddit-emotes/docs/help.htm");
	...
	public void openAbout() {
		Intent intent = new Intent(this, WebActivity.class);
		intent.putExtra("url",
				"http://dinsfire.com/projects/reddit-emotes/docs/about.htm");
	...
	public void updateDatabase() {
		...
		if (!Download.isConnectedToMobile(this.getApplicationContext())
				|| !prefs.disableOnMobile()) {
			new DownloadCompareDatabases(MainActivity.this)
					.execute(dbController);
		} else {
			notifications.disabledOnMobile();
		}
	}

	private class DownloadCompareDatabases extends
		...
		protected ArrayList<String> doInBackground(Object... params) {
			...
			if (!Download.from(EmoteDownloadService.SERVER_DB_URL, context
					.getCacheDir().toString()
					+ "/"
					+ DatabaseOpenHelper.SERVER_DATABASE_NAME)) {

				serverDBController = new DatabaseController(context, context
						.getCacheDir().toString()
						+ "/"
						+ DatabaseOpenHelper.SERVER_DATABASE_NAME);
				...
				emotesToDownload = serverDBController.getDifferences(
						...
						prefs.includeNSFW(), dbController);
	...
	public void downloadNewEmotes(ArrayList<String> emotesToDownload) {
		...
		if (emotesToDownload == null) {
			...
			intent.putExtra("receiver",
					new EmoteDownloadReciever(new Handler()));
	...
	public void onboardingSession() {
		if (prefs.onboardingSession()) {
			...
			builder.setMessage(R.string.onboardingMessage).setTitle(
					R.string.onboardingTitle);

			builder.setPositiveButton(R.string.onboardingOk,
			...
			builder.setNegativeButton(R.string.onboardingNo,
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int id) {
							// updateDatabase();
						}
