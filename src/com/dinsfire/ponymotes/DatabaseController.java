...
public class DatabaseController {
	...
	Cursor cursor = emoteDatabase.query(DatabaseOpenHelper.TABLE_EMOTES,
		new String[] { DatabaseOpenHelper.COLUMN_EMOTE_NAME }, query, splited, null, null,
		DatabaseOpenHelper.COLUMN_EMOTE_NAME, limit);
	...
	Cursor cursor = emoteDatabase.query(DatabaseOpenHelper.TABLE_EMOTES, columns, where, arguments, null, null,
		null);
    ...
    public ArrayList<String> getDifferences(boolean downloadEmotes, boolean downloadMissingEmotes, boolean includeNSFW,
	...
	while (newCursor.isAfterLast() == false) {
		...
		if (oldCursor.getCount() > 0) {
		    ...
		    int oldDateModified = oldCursor.getInt(oldCursor
