...
public class Notifications {
	...
	public Notifications(Context context, NotificationManager mNotifyManager, NotificationCompat.Builder mBuilder, PendingIntent pendingIntent) {
	...
	public void downloadingUpdate(int size, int progress, String emoteName) {
    	...
    	mBuilder
    	.setContentText("(" + progress + "/" + (size) + ") " + emoteName)
    	.setContentInfo("" + progress + "/" + (size))
    	.setOngoing(true);
    	publish();
	}
