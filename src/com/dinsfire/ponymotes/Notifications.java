...
public class Notifications {
	...
	public Notifications(Context context, NotificationManager mNotifyManager,
			NotificationCompat.Builder mBuilder, PendingIntent pendingIntent) {
	...
	public void disabledOnMobile() {
		mBuilder.setContentTitle(context.getString(R.string.notificationTitle))
				...
				.setSmallIcon(R.drawable.error).setProgress(0, 0, false)
				.setOngoing(false);
		publish();
	}
	...
	public void downloadingDatabase() {
		mBuilder.setContentTitle(context.getString(R.string.notificationTitle))
				.setContentText(
						context.getString(R.string.downloadingNewDatabase))
	...
	public void connectionError() {
		mBuilder.setContentTitle(context.getString(R.string.notificationTitle))
				...
				.setSmallIcon(R.drawable.error).setOngoing(false);
		publish();
	}
	...
	public void upToDate() {
		mBuilder.setContentTitle(context.getString(R.string.notificationTitle))
				.setProgress(0, 0, false)
				.setContentText(context.getString(R.string.upToDate))
				.setSmallIcon(R.drawable.checkmark).setOngoing(false);
		publish();
	}
